...
export function BlogListClient({ posts }: BlogListClientProps) {
  return (
    <div className="w-full max-w-3xl mx-auto px-8 sm:px-12 relative pb-16 pt-10 text-neutral-700 dark:text-neutral-300 font-sans leading-relaxed border-l border-r border-solid border-neutral-200 dark:border-white/[0.03]">
      <header className="relative pt-6 pb-6 w-full text-center sm:text-left">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-neutral-900 dark:text-white tracking-wide mb-4">
            Blog
          </h1>
