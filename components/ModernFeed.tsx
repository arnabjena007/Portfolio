        ...
        <div className="w-full max-w-3xl mx-auto px-8 sm:px-12 relative pb-16 text-neutral-700 dark:text-neutral-300 font-sans leading-relaxed border-l border-r border-solid border-neutral-200 dark:border-white/[0.03]">
            ...
            <header className="relative pt-10 pb-6 w-full">
                ...
                <div className="relative z-10 flex flex-col items-center sm:items-start text-center sm:text-left gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 w-full">
                        ...
                        <div className="flex flex-col gap-2 shrink-0">
                            <div className="flex items-center justify-center sm:justify-start gap-2">
                                <h1 className="text-3xl md:text-4xl font-serif font-bold text-neutral-900 dark:text-white tracking-wide">
                                    Arnab Jena
                                </h1>
                    ...
                    <div className="mt-4 space-y-3 w-full">
                        ...
                        <p className="text-neutral-700 dark:text-neutral-300 text-base md:text-lg max-w-2xl leading-relaxed font-serif">
            ...
            <section className="space-y-5">
                <div className="relative py-3">
                    ...
                    <h2 className="text-2xl font-serif font-bold text-neutral-900 dark:text-white">Work Experience</h2>
                </div>
                <div className="space-y-2">
                    {workExperience.map((exp) => {
                        const isExpanded = expandedId === exp.id;
                        return (
                            <div key={exp.id} className="border-b border-neutral-200 dark:border-neutral-900 pb-3">
                                <button
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className={`w-10 h-10 rounded-full border border-neutral-200 dark:border-neutral-800 ${exp.logo ? "bg-white p-1.5" : "bg-neutral-50 dark:bg-[#0c0c0e]"} group-hover:border-neutral-300 dark:group-hover:border-neutral-700 transition-colors flex items-center justify-center overflow-hidden shrink-0 select-none shadow-md`}>
                                            {exp.logo ? (
                                                <img src={exp.logo} alt={exp.company} className="w-full h-full object-contain" />
                                            ) : (
                                                <span className="font-bold text-sm text-neutral-500 dark:text-neutral-400 group-hover:text-neutral-800 dark:group-hover:text-white uppercase">
                                                    {exp.company.charAt(0)}
                                                </span>
                                            )}
                                        </div>
                                        <h3 className="text-base md:text-lg font-bold text-neutral-900 dark:text-white flex items-center gap-1.5 flex-wrap">
                                            <span className="font-instrument text-neutral-900 dark:text-white group-hover:text-yellow-600 dark:group-hover:text-yellow-500 transition-colors">{exp.company}</span>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-neutral-500 group-hover:text-neutral-800 dark:group-hover:text-white transition-colors">
                                ...
                                <AnimatePresence initial={false}>
                                    {isExpanded && (
                                        ...
                                        >
                                            <ul className="pl-14 pr-4 pb-3 space-y-2 text-neutral-600 dark:text-neutral-300 text-sm md:text-base font-sans leading-relaxed">
            ...
            <section className="space-y-5">
                <div className="relative py-3 flex items-center justify-between">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100vw] border-t border-neutral-200 dark:border-neutral-800/50" />
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[100vw] border-b border-neutral-200 dark:border-neutral-800/50" />
                    <h2 className="text-2xl font-serif font-bold text-neutral-900 dark:text-white">Projects</h2>
                            ...
                            <div className="flex-1 flex flex-col justify-between gap-3 relative">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-start w-full gap-4">
                                        <h3 className="text-lg font-bold text-neutral-900 dark:text-white group-hover:text-yellow-600 dark:group-hover:text-yellow-500 transition-colors font-serif">
                                            {project.title}
                                        </h3>
                                ...
                                <div className="flex flex-wrap gap-1.5 mt-auto">
                                    {project.techStack?.slice(0, 4).map((tech, idx) => (
                                        <span key={idx} className="px-2 py-0.5 text-[10px] font-mono rounded-md bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-neutral-600 dark:text-neutral-400">
                                            {tech}
                                        </span>
                                    ))}
                                </div>
            ...
            <section className="space-y-4">
                <div className="relative py-3">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100vw] border-t border-neutral-200 dark:border-neutral-800/50" />
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[100vw] border-b border-neutral-200 dark:border-neutral-800/50" />
                    <h2 className="text-2xl font-serif font-bold text-neutral-900 dark:text-white">GitHub Activity</h2>
                </div>
