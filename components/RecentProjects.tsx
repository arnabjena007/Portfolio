        ...
        <div className='py-20' id="projects">
            ...
            <div className='flex flex-wrap items-center justify-center p-4 gap-16 mt-10'>
                {projects.slice(0, 2).map(({ id, title, techStack, img, iconLists, link }) => (
                    <div key={id} className='lg:min-h-[28rem] h-[25rem] flex flex-col items-center justify-center sm:w-96 w-[80vw] border border-white/20 rounded-2xl bg-[#0f0f11] p-4 gap-4'>
