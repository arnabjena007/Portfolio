...
export const projects = [
    ...
    },
    {
        id: 4,
        title: "Pastelle",
        des: "A polished editor for marking up PDFs with soft premium visuals and focused annotation tools.",
        img: "/pastellet-screenshot.png",
        iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/ver.svg"],
        link: "https://pastelle-devo.vercel.app/editor",
        category: "Community Platform",
        techStack: ["HTML", "CSS", "JavaScript", "Firestore", "Vercel"],
        details: "Pastelle is a polished PDF editor built to keep the workspace calm and uncluttered while making annotation and page control feel fast, premium, and easy to use.",
        features: [
